      ...
      <div className="fixed inset-0 z-10 flex items-center justify-center pointer-events-none">
        ...
        >
          ...
          >
            ...
            availability,{" "}
            <span className="text-accent font-medium">infinitely</span>
          </p>

          <div className="flex items-center gap-6">
            <button
              className={`rounded-full px-8 py-3.5 text-sm font-medium hover:scale-105 transition-all duration-300 ${isDarkMode ? "bg-white text-black hover:bg-gray-200" : "bg-dark text-white"}`}
            >
              Try now
            </button>
            <button
              className={`text-sm font-medium hover:opacity-70 transition-opacity flex items-center gap-1 ${isDarkMode ? "text-white" : "text-dark"}`}
            >
